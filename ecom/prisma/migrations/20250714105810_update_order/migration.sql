/*
  ...
  - Added the required column `productTranslation` to the `ProductSKUSnapshot` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "productTranslation" JSONB NOT NULL,
